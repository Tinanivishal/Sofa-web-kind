-- CreateEnum
CREATE TYPE "Role" AS ENUM ('USER', 'ADMIN', 'MANAGER', 'TECHNICIAN');
...
-- CreateEnum
CREATE TYPE "RepairType" AS ENUM ('UPHOLSTERY', 'FRAME', 'CUSHION', 'CLEANING', 'OTHER');
...
-- AddForeignKey
ALTER TABLE "RepairBooking" ADD CONSTRAINT "RepairBooking_assignedTechnicianId_fkey" FOREIGN KEY ("assignedTechnicianId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
